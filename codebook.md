...
The objectives of this code is to present a tidy dataset base on the UCI HAR Dataset. The description for the original dataset is below. Following that, I describe how I've summarized the data.

Original UCI Desctiprion: Feature Selection 
==============
...
Summarized Data Approach
=================
First, we were are only interested in measurements of mean and standard deviation for all the metrics . The variable "meanandstd" identifies the hows of the metrics in the original data set that are measurements of mean and standard deviation.
